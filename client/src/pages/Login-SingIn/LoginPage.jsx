...
//     e.preventDefault();
//     try {
//       const response = await api.auth.login( email, password ); // Pass email and password as an object to the login function
...
//     } catch (error) {
//       dispatch(loginFailure(error.message)); // Dispatch a failure action with the error message
//     }
//   };
...
function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    handleLogin(e, email, password, dispatch, navigate);
  };
