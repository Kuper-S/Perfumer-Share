...
import { MDBIcon, MDBPopover, MDBPopoverBody } from 'mdbreact';
import {
  MDBContainer,
  MDBInput,
  MDBCheckbox,
      ...
      <MDBRow>
        ...
        <MDBCol md='6' className='text-center text-md-start d-flex flex-column justify-content-center'>
          ...
          <h1 className="my-5 display-3 fw-bold ls-tight px-3" style={{color: 'hsl(320, 81%, 75%)'}}>
            ScentShare <br />
            <span style={{color: 'hsl(280, 81%, 75%)'}}>for secnts lovers</span>
          </h1>
        ...
        <MDBCol md='6' className='position-relative'>
          ...
          <MDBCard className='my-5 bg-glass'>
            <MDBCardBody className='p-5'>
              ...
              <MDBBtn className='w-100 mb-4' size='md' color="indigo" style={{backgroundColor: 'rgb(85, 0, 128)'}}>sign up</MDBBtn>
